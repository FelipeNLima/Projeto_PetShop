...
include '..\Model\ServicoModel.php';
...
{   
    if($objServico->CadastrarServico($_POST) === 'ok')
    {
        header("location: ..\View\PrincipalServico.php");
    }
    else
    {
        echo '<script type="text/javascript">alert("Erro ao Cadastrar Serviço");</script>';
    }
}

if(isset($_POST['bteditar'])){
    if($objServico->AtualizarServico($_POST) === 'ok')
    {
        header("location: ../View/PrincipalServico.php");
    }
    else
    {   
      echo '<script type="text/javascript">alert("Erro ao Atualizar Serviço");</script>';
    }
}


if(isset($_POST['btdeletar'])){
    if($objServico->DeletarServico($_POST) === 'ok')
    {
        header("location: ../View/PrincipalServico.php");
    }
    else
    {   
      echo '<script type="text/javascript">alert("Erro ao Deletar Serviço");</script>';
    }
}
